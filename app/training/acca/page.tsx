...
export default function ACCATrainingPage() {
  const programDetails = {
    title: 'ACCA Certification Program',
  ...
  const benefits = [
    ...
    'Comprehensive knowledge of international accounting standards',
    'Professional credibility and recognition',
    'Flexible study options to fit your schedule',
    'Access to exclusive ACCA member benefits'
  ]

  const whatToExpect = [
    {
      title: 'Comprehensive Study Materials',
      description: 'Access to official ACCA study texts, practice questions, and mock exams',
      icon: <BookOpen className="w-6 h-6 text-primary-500" />
    },
    {
      title: 'Expert Instruction',
      description: 'Learn from qualified ACCA tutors with extensive industry experience',
      icon: <Users className="w-6 h-6 text-primary-500" />
    },
    {
      title: 'Exam Preparation',
      description: 'Intensive exam preparation with practice tests and revision sessions',
      icon: <Target className="w-6 h-6 text-primary-500" />
    },
    {
      title: 'Career Support',
      description: 'Guidance on career development and job placement assistance',
  ...
  const requirements = [
    ...
    'Basic understanding of accounting principles (recommended)',
    'Commitment to complete the program',
    'Access to computer and internet for online components'
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
                <span className="text-primary-500">ACCA</span> Certification Program
              </h1>
              
              <p className="text-xl text-gray-600 mb-8">
                Master the Association of Chartered Certified Accountants qualification and advance your career in accounting and finance with globally recognized expertise.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">ACCA Certification</h3>
              <p className="text-gray-600">Globally recognized accounting qualification</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                The ACCA (Association of Chartered Certified Accountants) qualification is one of the most prestigious and globally recognized accounting certifications. Our comprehensive program covers all 13 papers required for ACCA membership, providing you with the knowledge and skills needed to excel in accounting and finance roles worldwide.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our program combines theoretical knowledge with practical application, ensuring you're well-prepared for both the examinations and real-world accounting challenges. With flexible study options and expert instruction, you can achieve your ACCA qualification while balancing your professional and personal commitments.
              </p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our ACCA program provides comprehensive support and resources to ensure your success.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto mb-8">
              Join thousands of professionals who have advanced their careers with ACCA certification. Book your consultation today.
            </p>
